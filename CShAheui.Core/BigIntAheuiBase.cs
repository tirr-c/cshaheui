...
{
    public abstract class BigIntAheuiBase : AheuiBase<BigIntStorage, BigInteger>
    {
        public BigIntAheuiBase()
        {
        }

        protected override void WriteChar(BigInteger val)
        {
        ...
        protected override BigInteger Calculate(BigInteger a, BigInteger b, BinaryOperation operation)
        {
            switch (operation)
            {
        ...
        protected override BigInteger ReadFromInput(int argument)
        {
            if (argument == -1)
            {
                BigInteger number = 0;
